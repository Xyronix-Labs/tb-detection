                ...
                <section className="mb-8">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
                        {Object.entries(symptoms).map(([key, value]) => (
                            <p
                                key={key}
                                className={`p-3 rounded-lg text-sm sm:text-base ${value ? "bg-red-600/30 border border-red-500" : "bg-gray-800"
                                    }`}
                            >
                    ...
                    <button
                        onClick={async () => {
                            const newReport = {
                                ...
                                notes: `Symptoms: ${JSON.stringify(symptoms)}, History: ${JSON.stringify(medicalHistory)}`
                            };
