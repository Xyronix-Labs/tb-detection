    ...
    <div className="flex h-screen bg-gradient-to-r from-blue-900 via-purple-900 to-black">
      ...
      >
        ...
        <nav className="flex flex-col gap-4 px-4 mt-4">
          <button className="py-2 px-3 rounded-lg bg-blue-600 hover:bg-blue-700">
            Dashboard
          </button>
          <button className="py-2 px-3 hover:bg-gray-700 rounded-lg">Appointment</button>
          ...
          <button className="py-2 px-3 text-red-500 hover:bg-gray-700 rounded-lg">Sign Out</button>
        </nav>
      </aside>
      ...
      <main className="flex-1 p-6 overflow-y-auto w-full">
        ...
        <div className="flex justify-between items-center mb-6">
          ...
          <div className="flex items-center gap-3">
            <div className="text-right hidden sm:block">
              ...
              <p className="text-sm text-gray-400">jenny@example.com</p>
            </div>
        ...
        <div className="bg-gradient-to-r from-blue-600 via-purple-600 text-white rounded-xl p-6 flex flex-col md:flex-row justify-between items-center mb-6 h-auto md:h-60">
          <div className="mb-4 md:mb-0">
            <h2 className="text-2xl font-bold">Welcome to TB DETECTION APP</h2>
            <button
      ...
      <aside className="hidden lg:block w-72 bg-gray-800 shadow-lg p-6">
        <div className="mb-6">
        ...
        <div>
          ...
          <div className="space-y-3">
            <div className="bg-blue-500 p-3 rounded-lg">
              <p className="font-medium">Dietary Couns...</p>
              <p className="text-sm text-gray-900">11:00 AM</p>
            </div>
            <div className="bg-blue-500 p-3 rounded-lg">
              <p className="font-medium">Rehabilitation</p>
              <p className="text-sm text-gray-900">15:00 PM</p>
            </div>
            <div className="bg-blue-500 p-3 rounded-lg">
